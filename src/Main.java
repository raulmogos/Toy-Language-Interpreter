...
public class Main {
    public static void main(String[] argv) {
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable1 = new MyMap<>();
        ProgramState prg1 = new ProgramState(statements1, symbols1, output1, fileTable1, heap1, semaphoreTable1, ex1);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable2 = new MyMap<>();
        ProgramState prg2 = new ProgramState(statements2, symbols2, output2, fileTable2, heap2, semaphoreTable2, ex2);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable3 = new MyMap<>();
        ProgramState prg3 = new ProgramState(statements3, symbols3, output3, fileTable3, heap3, semaphoreTable3, ex3);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable4 = new MyMap<>();
        ProgramState prg4 = new ProgramState(statements4, symbols4, output4, fileTable4, heap4, semaphoreTable4, ex4);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable5 = new MyMap<>();
        ProgramState prg5 = new ProgramState(statements5, symbols5, output5, fileTable5, heap5, semaphoreTable5, ex5);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable6 = new MyMap<>();
        ProgramState prg6 = new ProgramState(statements6, symbols6, output6, fileTable6, heap6, semaphoreTable6, ex6);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable7 = new MyMap<>();
        ProgramState prg7 = new ProgramState(statements7, symbols7, output7, fileTable7, heap7, semaphoreTable7, ex7);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable8 = new MyMap<>();
        ProgramState prg8 = new ProgramState(statements8, symbols8, output8, fileTable8, heap8, semaphoreTable8, ex8);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable9 = new MyMap<>();
        ProgramState prg9 = new ProgramState(statements9, symbols9, output9, fileTable9, heap9, semaphoreTable9, ex9);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable10 = new MyMap<>();
        ProgramState prg10 = new ProgramState(statements10, symbols10, output10, fileTable10, heap10, semaphoreTable10, ex10);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable11 = new MyMap<>();
        ProgramState prg11 = new ProgramState(statements11, symbols11, output11, fileTable11, heap11, semaphoreTable11, ex11);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable12 = new MyMap<>();
        ProgramState prg12 = new ProgramState(statements12, symbols12, output12, fileTable12, heap12, semaphoreTable12, ex12);
        ...
        IMyMap<Integer, Pair<Integer, List<Integer>>> semaphoreTable13 = new MyMap<>();
        ProgramState prg13 = new ProgramState(statements13, symbols13, output13, fileTable13, heap13, semaphoreTable13, ex13);
...
//        }
        ...
        //
//        System.out.println(Programs.program_13);
